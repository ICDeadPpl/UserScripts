...
const indexers = [
  {
    name: 'NZBIndex',
    url: 'https://dereferer.me/?https://nzbindex.com/search?max=25&minage=&maxage=&hidespam=1&hidepassword=0&sort=agedesc&minsize=&maxsize=&complete=0&hidecross=0&hasNFO=0&poster=&q={query}',
  ...
  {
    name: 'BinSearch',
    url: 'https://dereferer.me/?https://www.binsearch.info/?max=1000&&adv_age=&adv_sort=date&server=2&&q={query}',
    codeFn: function(code) {
      return sanatize_common(code);
    }
  },
  {
    ...
    url: 'https://dereferer.me/?https://www.binsearch.info/?max=100&adv_g=alt.binaries.mp3.abooks&adv_age=&adv_sort=date&q={query}',
    codeFn: function(code) {
      return sanatize_common(code);
    }
  },
  {
    name: 'NZBKing',
    url: 'https://dereferer.me/?http://nzbking.com/search/?q=%22{query}%22',
    codeFn: function(code) {
      return sanatize_common(code);
    }
  }
